...
calculation_type = st.sidebar.selectbox(
    "Select Calculation Type" if st.session_state.language == 'en' else "选择计算类型",
    ["Spread", "Equity", "Margin"]
)

# Product selection dropdown in sidebar
...
if product == "Gold (XAUUSD)":
    ...
    product_pair = st.sidebar.selectbox(
    ...
    crypto_pair = st.sidebar.selectbox(
        ...
        ["BTC/USD", "ETH/USD", "BNB/USD", "XRP/USD", "LTC/USD"]
    )
    unit = "cents"
...
elif calculation_type == "Equity":
    # Add equity calculation logic here
    pass

elif calculation_type == "Margin":
    # Add margin calculation logic here
    pass
